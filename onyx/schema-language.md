...
all optional, plus a handful of optional [value constraints](#value-constraints)
...
[`validate.mjs`](./validate.mjs) (see the `Value constraints` section) and
[`example-constrained.json`](./example-constrained.json) exercises them together.
