 ...
 *
 * @generated from message com.seed.documents.v3alpha.ListUnreferencedDocumentsRequest
 */
export class ListUnreferencedDocumentsRequest extends Message<ListUnreferencedDocumentsRequest> {
  /**
  ...
  constructor(data?: PartialMessage<ListUnreferencedDocumentsRequest>) {
    super();
    proto3.util.initPartial(data, this);
  }

  static readonly runtime: typeof proto3 = proto3;
  static readonly typeName = "com.seed.documents.v3alpha.ListUnreferencedDocumentsRequest";
  static readonly fields: FieldList = proto3.util.newFieldList(() => [
    { no: 1, name: "account", kind: "scalar", T: 9 /* ScalarType.STRING */ },
    { no: 2, name: "page_size", kind: "scalar", T: 5 /* ScalarType.INT32 */ },
    { no: 3, name: "page_token", kind: "scalar", T: 9 /* ScalarType.STRING */ },
  ...
  static fromBinary(bytes: Uint8Array, options?: Partial<BinaryReadOptions>): ListUnreferencedDocumentsRequest {
    return new ListUnreferencedDocumentsRequest().fromBinary(bytes, options);
  }

  static fromJson(jsonValue: JsonValue, options?: Partial<JsonReadOptions>): ListUnreferencedDocumentsRequest {
    return new ListUnreferencedDocumentsRequest().fromJson(jsonValue, options);
  }

  static fromJsonString(jsonString: string, options?: Partial<JsonReadOptions>): ListUnreferencedDocumentsRequest {
    return new ListUnreferencedDocumentsRequest().fromJsonString(jsonString, options);
  }

  static equals(a: ListUnreferencedDocumentsRequest | PlainMessage<ListUnreferencedDocumentsRequest> | undefined, b: ListUnreferencedDocumentsRequest | PlainMessage<ListUnreferencedDocumentsRequest> | undefined): boolean {
    return proto3.util.equals(ListUnreferencedDocumentsRequest, a, b);
  }
}
 ...
 *
 * @generated from message com.seed.documents.v3alpha.ListUnreferencedDocumentsResponse
 */
export class ListUnreferencedDocumentsResponse extends Message<ListUnreferencedDocumentsResponse> {
  /**
   ...
   *
   * @generated from field: bool index_incomplete = 3;
   */
  indexIncomplete = false;

  constructor(data?: PartialMessage<ListUnreferencedDocumentsResponse>) {
    super();
    proto3.util.initPartial(data, this);
  }

  static readonly runtime: typeof proto3 = proto3;
  static readonly typeName = "com.seed.documents.v3alpha.ListUnreferencedDocumentsResponse";
  static readonly fields: FieldList = proto3.util.newFieldList(() => [
    { no: 1, name: "documents", kind: "message", T: DocumentInfo, repeated: true },
    { no: 2, name: "next_page_token", kind: "scalar", T: 9 /* ScalarType.STRING */ },
    { no: 3, name: "index_incomplete", kind: "scalar", T: 8 /* ScalarType.BOOL */ },
  ]);

  static fromBinary(bytes: Uint8Array, options?: Partial<BinaryReadOptions>): ListUnreferencedDocumentsResponse {
    return new ListUnreferencedDocumentsResponse().fromBinary(bytes, options);
  }

  static fromJson(jsonValue: JsonValue, options?: Partial<JsonReadOptions>): ListUnreferencedDocumentsResponse {
    return new ListUnreferencedDocumentsResponse().fromJson(jsonValue, options);
  }

  static fromJsonString(jsonString: string, options?: Partial<JsonReadOptions>): ListUnreferencedDocumentsResponse {
    return new ListUnreferencedDocumentsResponse().fromJsonString(jsonString, options);
  }

  static equals(a: ListUnreferencedDocumentsResponse | PlainMessage<ListUnreferencedDocumentsResponse> | undefined, b: ListUnreferencedDocumentsResponse | PlainMessage<ListUnreferencedDocumentsResponse> | undefined): boolean {
    return proto3.util.equals(ListUnreferencedDocumentsResponse, a, b);
  }
}
