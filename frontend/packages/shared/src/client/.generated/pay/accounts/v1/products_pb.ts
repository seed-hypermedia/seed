...
/**
 * @generated from enum accounts.v1.ProductType
 */
export enum ProductType {
   ...
   * allow users to receive donations from their customers. Users won't be able
   * to get invoices for this product.
   *
   * @generated from enum value: DONATION = 1;
   */
  DONATION = 1,
   ...
   *
   * @generated from enum value: ONE_TIME_PURCHASE = 3;
   */
  ONE_TIME_PURCHASE = 3,
}
// Retrieve enum metadata with: proto3.getEnumType(ProductType)
proto3.util.setEnumType(ProductType, "accounts.v1.ProductType", [
  { no: 0, name: "PRODUCT_TYPE_UNKNOWN" },
  { no: 1, name: "DONATION" },
  { no: 2, name: "SUBSCRIPTION" },
  { no: 3, name: "ONE_TIME_PURCHASE" },
]);

/**
 * The Create product Request used to create a new product for an account
 * to be monetized.
 * The user must provide proof of ownership of the product uid by signing a
 * message with the private key associated with the product uid and attaching
 * the signature to the request as a `signature` field in the request header.
 *
 * @generated from message accounts.v1.CreateProductRequest
 */
export class CreateProductRequest extends Message<CreateProductRequest> {
   ...
   * subscription price.
   *
   * @generated from field: string price_id = 5;
   */
  priceId = "";
   ...
   *
   * @generated from field: string statement_description = 6;
   */
  ...
  static readonly typeName = "accounts.v1.CreateProductRequest";
  static readonly fields: FieldList = proto3.util.newFieldList(() => [
    { no: 1, name: "uid", kind: "scalar", T: 9 /* ScalarType.STRING */ },
    { no: 2, name: "name", kind: "scalar", T: 9 /* ScalarType.STRING */ },
    { no: 3, name: "description", kind: "scalar", T: 9 /* ScalarType.STRING */ },
    { no: 4, name: "url", kind: "scalar", T: 9 /* ScalarType.STRING */ },
    { no: 5, name: "price_id", kind: "scalar", T: 9 /* ScalarType.STRING */ },
    { no: 6, name: "statement_description", kind: "scalar", T: 9 /* ScalarType.STRING */ },
 ...
 *
 * @generated from message accounts.v1.Product
 */
export class Product extends Message<Product> {
   ...
   *
   * @generated from field: accounts.v1.ProductType type = 3;
   */
  ...
  static readonly runtime: typeof proto3 = proto3;
  static readonly typeName = "accounts.v1.Product";
  static readonly fields: FieldList = proto3.util.newFieldList(() => [
 ...
 * the signature to the request as a `signature` field in the request header.
 *
 * @generated from message accounts.v1.UpdateProductRequest
 */
export class UpdateProductRequest extends Message<UpdateProductRequest> {
  ...
  static readonly runtime: typeof proto3 = proto3;
  static readonly typeName = "accounts.v1.UpdateProductRequest";
  static readonly fields: FieldList = proto3.util.newFieldList(() => [
    { no: 1, name: "uid", kind: "scalar", T: 9 /* ScalarType.STRING */ },
 ...
 * the signature to the request as a `signature` field in the request header.
 *
 * @generated from message accounts.v1.DeleteProductRequest
 */
export class DeleteProductRequest extends Message<DeleteProductRequest> {
  ...
  static readonly runtime: typeof proto3 = proto3;
  static readonly typeName = "accounts.v1.DeleteProductRequest";
  static readonly fields: FieldList = proto3.util.newFieldList(() => [
    { no: 1, name: "uid", kind: "scalar", T: 9 /* ScalarType.STRING */ },
    { no: 2, name: "id", kind: "scalar", T: 9 /* ScalarType.STRING */ },
  ]);
 ...
 * request header.
 *
 * @generated from message accounts.v1.ListProductRequest
 */
export class ListProductRequest extends Message<ListProductRequest> {
  ...
  static readonly runtime: typeof proto3 = proto3;
  static readonly typeName = "accounts.v1.ListProductRequest";
  static readonly fields: FieldList = proto3.util.newFieldList(() => [
    { no: 1, name: "uid", kind: "scalar", T: 9 /* ScalarType.STRING */ },
 ...
 *
 * @generated from message accounts.v1.ListProductsResponse
 */
export class ListProductsResponse extends Message<ListProductsResponse> {
  /**
   * The list of the products.
   *
   * @generated from field: repeated accounts.v1.Product products = 1;
   */
  products: Product[] = [];
  ...
  static readonly runtime: typeof proto3 = proto3;
  static readonly typeName = "accounts.v1.ListProductsResponse";
  static readonly fields: FieldList = proto3.util.newFieldList(() => [
