...
/**
 * @generated from enum accounts.v1.PriceType
 */
export enum PriceType {
  ...
  /**
   * The price is an open price. This means that the customer can choose how
   * much to pay. The platform will omit the amount and currency on price_info
   * for this type of price.
   *
   * @generated from enum value: OPEN_PRICE = 1;
   */
  OPEN_PRICE = 1,
   ...
   * fixed amount.
   *
   * @generated from enum value: FIXED_PRICE = 2;
   */
  FIXED_PRICE = 2,
}
// Retrieve enum metadata with: proto3.getEnumType(PriceType)
proto3.util.setEnumType(PriceType, "accounts.v1.PriceType", [
  { no: 0, name: "PRICE_TYPE_UNKNOWN" },
  { no: 1, name: "OPEN_PRICE" },
  { no: 2, name: "FIXED_PRICE" },
]);
 ...
 * and attaching the signature to the request as a `signature` field in the
 * request header.
 *
 * @generated from message accounts.v1.CreatePriceRequest
 */
export class CreatePriceRequest extends Message<CreatePriceRequest> {
   ...
   *
   * @generated from field: accounts.v1.PriceType type = 3;
   */
   ...
   *
   * @generated from field: repeated accounts.v1.price_info info = 4;
   */
  info: price_info[] = [];
  ...
  static readonly typeName = "accounts.v1.CreatePriceRequest";
 ...
 * request header.
 *
 * @generated from message accounts.v1.UpdatePriceRequest
 */
export class UpdatePriceRequest extends Message<UpdatePriceRequest> {
   ...
   * is charged to the customers.
   *
   * @generated from field: accounts.v1.PriceType type = 4;
   */
  type = PriceType.PRICE_TYPE_UNKNOWN;
   ...
   * used.
   *
   * @generated from field: repeated accounts.v1.price_info info = 5;
   */
  info: price_info[] = [];
  ...
  static readonly runtime: typeof proto3 = proto3;
  static readonly typeName = "accounts.v1.UpdatePriceRequest";
  static readonly fields: FieldList = proto3.util.newFieldList(() => [
    { no: 1, name: "uid", kind: "scalar", T: 9 /* ScalarType.STRING */ },
    { no: 2, name: "id", kind: "scalar", T: 9 /* ScalarType.STRING */ },
    { no: 3, name: "description", kind: "scalar", T: 9 /* ScalarType.STRING */ },
    { no: 4, name: "type", kind: "enum", T: proto3.getEnumType(PriceType) },
    { no: 5, name: "info", kind: "message", T: price_info, repeated: true },
  ]);
 ...
 * uid by signing a message with the private key associated with the account uid
 * and attaching the signature to the request as a `signature` field in the
 * request header. A price can be deleted only if it is not associated with any
 * product.
 *
 * @generated from message accounts.v1.DeletePriceRequest
 */
export class DeletePriceRequest extends Message<DeletePriceRequest> {
  ...
  static readonly runtime: typeof proto3 = proto3;
  static readonly typeName = "accounts.v1.DeletePriceRequest";
  static readonly fields: FieldList = proto3.util.newFieldList(() => [
    { no: 1, name: "uid", kind: "scalar", T: 9 /* ScalarType.STRING */ },
    { no: 2, name: "id", kind: "scalar", T: 9 /* ScalarType.STRING */ },
  ]);
 ...
 * request header.
 *
 * @generated from message accounts.v1.ListPricesRequest
 */
export class ListPricesRequest extends Message<ListPricesRequest> {
  ...
  static readonly runtime: typeof proto3 = proto3;
  static readonly typeName = "accounts.v1.ListPricesRequest";
  static readonly fields: FieldList = proto3.util.newFieldList(() => [
    { no: 1, name: "uid", kind: "scalar", T: 9 /* ScalarType.STRING */ },
 ...
 *
 * @generated from message accounts.v1.ListPricessResponse
 */
export class ListPricessResponse extends Message<ListPricessResponse> {
  /**
   * The list of prices for the account.
   *
   * @generated from field: repeated accounts.v1.Price prices = 1;
   */
  prices: Price[] = [];
  ...
  static readonly runtime: typeof proto3 = proto3;
  static readonly typeName = "accounts.v1.ListPricessResponse";
  static readonly fields: FieldList = proto3.util.newFieldList(() => [
 ...
 *
 * @generated from message accounts.v1.Price
 */
export class Price extends Message<Price> {
  ...
  /**
   * The platform percentage fee (0.01-0.99) that will be substracted from the
   * amount charged to the customers. This fee is charged by the platform for
   * processing the payment and providing the service. The platform fee is
   * charged in the same currency as the price. There is a minimum 1% fee to be
   * enforced by the platform.
   *
   * @generated from field: float platform_fee_pct = 5;
   */
  platformFeePct = 0;
  ...
  static readonly runtime: typeof proto3 = proto3;
  static readonly typeName = "accounts.v1.Price";
  static readonly fields: FieldList = proto3.util.newFieldList(() => [
    { no: 1, name: "id", kind: "scalar", T: 9 /* ScalarType.STRING */ },
    { no: 2, name: "description", kind: "scalar", T: 9 /* ScalarType.STRING */ },
    { no: 3, name: "type", kind: "enum", T: proto3.getEnumType(PriceType) },
    { no: 4, name: "info", kind: "message", T: price_info, repeated: true },
    { no: 5, name: "platform_fee_pct", kind: "scalar", T: 2 /* ScalarType.FLOAT */ },
  ]);
 ...
 * received by the account will be amount - platform_fee_pct*amount - payment
 * processing fees.
 *
 * @generated from message accounts.v1.price_info
 */
export class price_info extends Message<price_info> {
  ...
  static readonly runtime: typeof proto3 = proto3;
  static readonly typeName = "accounts.v1.price_info";
  static readonly fields: FieldList = proto3.util.newFieldList(() => [
