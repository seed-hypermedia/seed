...
import { Citation } from "../../documents/v3alpha/resources_pb";

/**
 * The order used when listing activity feed events.
 *
 * @generated from enum com.seed.activity.v1alpha.FeedOrder
 */
export enum FeedOrder {
  /**
   * Default. Order by the timestamp claimed by the event/blob.
   *
   * @generated from enum value: FEED_ORDER_CLAIMED_TIME = 0;
   */
  CLAIMED_TIME = 0,
   ...
   *
   * @generated from enum value: FEED_ORDER_OBSERVED_TIME = 1;
   */
  OBSERVED_TIME = 1,
}
// Retrieve enum metadata with: proto3.getEnumType(FeedOrder)
proto3.util.setEnumType(FeedOrder, "com.seed.activity.v1alpha.FeedOrder", [
  { no: 0, name: "FEED_ORDER_CLAIMED_TIME" },
  { no: 1, name: "FEED_ORDER_OBSERVED_TIME" },
]);
...
export class ListEventsRequest extends Message<ListEventsRequest> {
   ...
   *
   * @generated from field: com.seed.activity.v1alpha.FeedOrder order = 7;
   */
  ...
  static readonly fields: FieldList = proto3.util.newFieldList(() => [
    ...
    { no: 7, name: "order", kind: "enum", T: proto3.getEnumType(FeedOrder) },
  ]);
...
export class Event extends Message<Event> {
  ...
  data: {
    ...
    /**
     * @generated from field: com.seed.documents.v3alpha.Citation new_citation = 5;
     */
    value: Citation;
    case: "newCitation";
  ...
  static readonly fields: FieldList = proto3.util.newFieldList(() => [
    ...
    { no: 5, name: "new_citation", kind: "message", T: Citation, oneof: "data" },
