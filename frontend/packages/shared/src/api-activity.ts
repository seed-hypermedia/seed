...
async function resolveEvent(
  ...
  try {
    ...
    switch (eventType) {
      case 'comment':
        resolvedEvent = await loadCommentEvent(
          grpcClient,
          event,
          currentAccount,
          cache,
        ...
        break
      case 'ref':
        resolvedEvent = await loadRefEvent(
          grpcClient,
          event,
          currentAccount,
          cache,
        ...
        break
      case 'capability':
        resolvedEvent = await loadCapabilityEvent(
          grpcClient,
          event,
          currentAccount,
          cache,
        ...
        break
      case 'contact':
        resolvedEvent = await loadContactEvent(
          grpcClient,
          event,
          currentAccount,
          cache,
      ...
      case 'doc/link':
      case 'doc/button':
        resolvedEvent = await loadCitationEvent(
          grpcClient,
          event,
          currentAccount,
          cache,
