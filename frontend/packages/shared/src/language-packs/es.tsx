...
const Translations = {
  ...
  logout_identity_inactive: 'Tu identidad ya no estará activa en este dispositivo.',
  logout_account_saved: 'Puedes volver a iniciar sesión en cualquier momento.',
  logout_account_not_saved:
    'Esta clave de cuenta no está guardada en ningún otro lugar, así que perderás acceso a esta identidad para siempre. Siempre puedes crear una nueva cuenta más tarde.',
