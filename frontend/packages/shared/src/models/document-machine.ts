import {HMDocument, HMDraft, HMNavigationItem, UnpackedHypermediaId} from '@seed-hypermedia/client/hm-types'
      ...
      states: {
        inProgress: {
          invoke: {
            ...
            onError: {
              target: '#DocumentLifecycle.editing.idle',
            },
          },
        },
        cleaningUp: {
