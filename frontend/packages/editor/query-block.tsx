import {SearchInput} from "@shm/desktop/src/components/search-input";
import {useListDirectory} from "@shm/desktop/src/models/documents";
import {useEntities, useEntity} from "@shm/desktop/src/models/entities";
import {LibraryData} from "@shm/desktop/src/models/library";
import {LibraryListItem} from "@shm/desktop/src/pages/library";
import {
  EditorQueryBlock,
  HMBlockQuery,
  HMEntityContent,
...
type HMQueryBlockSort = NonNullable<
  HMBlockQuery["attributes"]["query"]["sort"]
>;
