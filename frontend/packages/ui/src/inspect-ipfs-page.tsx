...
export function InspectIpfsPage({
  ...
  useEffect(() => {
    ...
    if (isMetaSeed) {
      ...
      setEditJson(extendBaseCid ? {type: `ipfs://${extendBaseCid}`, properties: {}} : emptyStructSchema())
          ...
          <SchemaRegistryProvider schema={schema} registry={{}} value={advisoryValue}>
            <div className="flex flex-col gap-4">
              ...
              {rawMode ? (
                ...
                <SchemaAwareEditor schema={HM_SCHEMAS['schema']!} value={editJson} onValue={update} />
              ) : (
