...
function DeleteCommentDraftDialog({onClose, input}: {onClose: () => void; input: {onConfirm: () => void}}) {
  return (
    <div className="bg-background flex flex-col gap-2 rounded-md p-4">
      <Text className="text-lg font-semibold">Discard Comment</Text>
      <Text className="text-muted-foreground text-sm">Permanently delete this draft comment?</Text>
