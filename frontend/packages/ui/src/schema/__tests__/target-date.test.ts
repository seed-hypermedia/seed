...
import {literalMembers, literalSchema, nameToUrl, HM_SCHEMAS, resolveSchema, validate} from '../engine'
import {subschemaAt} from '../schema-context'
...
describe('target references', () => {
  ...
  it('a character document exposes date, link and object fields with targets', () => {
    ...
    const at = (key: string) => subschemaAt(meta, [key], {}) as Record<string, any>
