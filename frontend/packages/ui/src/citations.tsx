...
function DocumentCitationToken({
  ...
  const className =
    'dark:border-gray-700 dark:bg-gray-800 dark:text-gray-200! hover:dark:border-gray-600 hover:dark:text-white text-sm bg-gray-200 border border-gray-300 px-1 py-0 rounded mt-1.5 whitespace-wrap break-all'
  if (DocPreview) {
    return (
      <HoverCard>
