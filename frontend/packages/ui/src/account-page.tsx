...
export function AccountPage({siteUid, accountUid, tab}: {siteUid?: string | null; accountUid: string; tab: ProfileTab}) {
...
function ProfileHeader({siteUid: _siteUid, accountUid}: {siteUid?: string | null; accountUid: string}) {
...
function AccountPageTabs({siteUid, accountUid, tab}: {siteUid?: string | null; accountUid: string; tab: SiteAccountTab}) {
