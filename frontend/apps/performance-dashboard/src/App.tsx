    ...
    return (
      <div className="dashboard-container">
        <div className="alert alert-error">
          <Icons.AlertTriangle className="alert-icon" />
    ...
    return (
      <div className="dashboard-container">
        <div className="alert alert-warning">
          <Icons.AlertTriangle className="alert-icon" />
          <div className="alert-content">
            <p className="alert-title">No performance test results found.</p>
            <p className="alert-message">
        ...
        <div className="header-content">
          <div>
            <h1 className="dashboard-title">
              <Icons.Activity className="dashboard-title-icon" />
              Seed Hypermedia Performance Dashboard
            </h1>
                        ...
                        <div key={index} className="memory-bar-container">
                          ...
                          <div className="memory-bar-wrapper">
                            <div
                              ...
                              style={{
                                width: `${
                                  (item.memory / averages.maxTotalMemory) * 100
                                }%`,
                              }}
                            ></div>
                          </div>
                          ...
                          (metric) => (
                            <div
                              ...
                              className={`detailed-metric-card ${
                                isConcerningMetric(metric.name, metric.value)
                                  ? "metric-concerning"
                                  : "metric-ok"
                              }`}
                            >
            ...
            <div className="tab-content">
              <div className="tab-header">
                ...
                <p className="tab-description">
                  ...
                  improvements or regressions. Changes are highlighted: green is
                  better, yellow/red indicates regression. You can select
