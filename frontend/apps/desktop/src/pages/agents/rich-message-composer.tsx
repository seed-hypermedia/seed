import type {RunStatus, SessionAttachmentInfo} from '@/agents-client'
import {type AgentSessionDraftMessage, uploadFileToAgentServer} from '@/models/agents'
...
export function AgentRichMessageComposer({
  ...
  composerHandleRef?: React.MutableRefObject<CommentEditorSubmitHandle | null>
  onSend: (message: AgentSessionDraftMessage) => void
  onStop: () => void
}) {
  const [draftMarkdown, setDraftMarkdown] = useState('')
  const internalHandleRef = useRef<CommentEditorSubmitHandle | null>(null)
