import {useAddCapabilities, useSelectedAccountCapability} from '@/models/access-control'
...
export const TagInput = forwardRef<HTMLInputElement, TagInputProps>(function TagInput(props, ref) {
...
export const TagInputItem = forwardRef<HTMLDivElement, TagInputItemProps>(function TagInputItem(props, ref) {
