  ...
  return (
    <>
      <div
        ...
        onClick={onClose}
      />
      <div className="no-window-drag dark:bg-background border-border absolute top-0 left-0 z-[9999] mt-6 h-[260px] min-h-8/10 w-full max-w-2xl overflow-hidden rounded-md border bg-white p-2">
        <SearchInput
          onClose={onClose}
          onSelect={({id, route}) => {
            if (route) {
