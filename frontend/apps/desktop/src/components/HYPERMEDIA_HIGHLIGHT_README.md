...
The blocks-content-provider.tsx contains hover handlers that broadcast events to all windows:
...
The HypermediaHighlight component, included in the main application layout, listens for these events and applies
highlighting:
...
- **No highlighting**: Make sure elements have `data-blockid` or `data-resourceid` attributes matching the ID being sent
