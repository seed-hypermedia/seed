      ...
      {showNewContentPill && (
        <div className="fixed top-20 left-1/2 z-50 -translate-x-1/2 transform">
          <button
            ...
            className="flex items-center justify-center gap-2 rounded-full bg-blue-500 px-4 py-2 font-medium whitespace-nowrap text-white shadow-lg transition-colors duration-200 hover:bg-blue-600"
          >
            <svg
              className="h-4 w-4"
              fill="none"
