...
export type NotificationReadStateAction = z.infer<
  typeof notificationReadStateAction
>
...
function toResponse(
  state: NotificationReadStateRow,
...
export const action = cborApiAction<NotificationReadStateAction, any>(
  async (signedPayload) => {
