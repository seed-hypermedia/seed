    ...
    (index: number, value: string) => {
      ...
      if (trimmedValue.includes(' ') || trimmedValue.includes(',')) {
        ...
        if (pastedWords.length >= 1) {
          ...
          const focusIndex =
            nextEmptyIndex !== -1 ? nextEmptyIndex : Math.min(index + pastedWords.length, WORD_COUNT - 1)
  ...
  return (
    <KeyboardAvoidingView style={styles.container} behavior={Platform.OS === 'ios' ? 'padding' : 'height'}>
      <ScrollView contentContainerStyle={styles.scrollContent} keyboardShouldPersistTaps="handled">
            ...
            return (
              <View key={index} style={styles.wordInputContainer}>
                ...
                <TextInput
                  ...
                  style={[styles.wordInput, isValid && styles.wordInputValid, isInvalid && styles.wordInputInvalid]}
                  value={word}
        ...
        {error && (
          <Text testID="mnemonic-error" style={styles.errorText}>
            {error}
          </Text>
        )}
        ...
        <View style={styles.buttonRow}>
          ...
          <TouchableOpacity testID="mnemonic-random" style={styles.secondaryButton} onPress={handleGenerateRandom}>
            <Text style={styles.secondaryButtonText}>Random</Text>
          </TouchableOpacity>
        </View>

        <TouchableOpacity
          testID="mnemonic-continue"
