...
export function HomeScreen({navigation, route}: Props) {
  ...
  useEffect(() => {
    ...
    // Test connection with a cheap request that works on any server
    async function testConnection() {
      try {
        const client = getSeedClient()
        await client.request('ListAccounts', undefined)
  ...
  return (
    <View style={styles.container}>
      ...
      <Text style={styles.infoText}>Client ready. Requests go to {serverName}.</Text>
    </View>
  )
}
