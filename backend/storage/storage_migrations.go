...
var migrations = []migration{
	// Reindex contacts so delegated signers resolve under the contact account resource.
	{Version: "2026-03-12.01", Run: func(_ *Store, conn *sqlite.Conn) error {
	...
	{Version: "2025-12-30.173836", Run: func(_ *Store, conn *sqlite.Conn) error {
		return sqlitex.ExecScript(conn, "CREATE INDEX blob_visibility_by_space ON blob_visibility (space, id);")
	}},
	...
	{Version: "2025-07-28.01", Run: func(_ *Store, conn *sqlite.Conn) error {
		if err := sqlitex.ExecScript(conn, sqlfmt(`
			DROP INDEX structural_blobs_by_tsid;
