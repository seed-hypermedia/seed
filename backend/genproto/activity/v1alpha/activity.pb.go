...
// The order used when listing activity feed events.
type FeedOrder int32

const (
	// Default. Order by the timestamp claimed by the event/blob.
	FeedOrder_FEED_ORDER_CLAIMED_TIME FeedOrder = 0
	// Order by the time the event/blob was observed locally.
	FeedOrder_FEED_ORDER_OBSERVED_TIME FeedOrder = 1
)

// Enum value maps for FeedOrder.
var (
	FeedOrder_name = map[int32]string{
		0: "FEED_ORDER_CLAIMED_TIME",
		1: "FEED_ORDER_OBSERVED_TIME",
	}
	FeedOrder_value = map[string]int32{
		"FEED_ORDER_CLAIMED_TIME":  0,
		"FEED_ORDER_OBSERVED_TIME": 1,
	}
)

func (x FeedOrder) Enum() *FeedOrder {
	p := new(FeedOrder)
	*p = x
	return p
}

func (x FeedOrder) String() string {
	return protoimpl.X.EnumStringOf(x.Descriptor(), protoreflect.EnumNumber(x))
}

func (FeedOrder) Descriptor() protoreflect.EnumDescriptor {
	return file_activity_v1alpha_activity_proto_enumTypes[0].Descriptor()
}

func (FeedOrder) Type() protoreflect.EnumType {
	return &file_activity_v1alpha_activity_proto_enumTypes[0]
}

func (x FeedOrder) Number() protoreflect.EnumNumber {
	return protoreflect.EnumNumber(x)
}

// Deprecated: Use FeedOrder.Descriptor instead.
func (FeedOrder) EnumDescriptor() ([]byte, []int) {
...
type ListEventsRequest struct {
	...
	// Optional. Controls feed ordering. Defaults to claimed event/blob time.
	Order         FeedOrder `protobuf:"varint,7,opt,name=order,proto3,enum=com.seed.activity.v1alpha.FeedOrder" json:"order,omitempty"`
...
func (x *ListEventsRequest) GetOrder() FeedOrder {
	if x != nil {
		return x.Order
	}
	return FeedOrder_FEED_ORDER_CLAIMED_TIME
}
...
func (x *Event) GetNewCitation() *v3alpha.Citation {
	if x != nil {
		if x, ok := x.Data.(*Event_NewCitation); ok {
			return x.NewCitation
		}
	}
	return nil
}
...
type Event_NewCitation struct {
	NewCitation *v3alpha.Citation `protobuf:"bytes,5,opt,name=new_citation,json=newCitation,proto3,oneof"`
}

func (*Event_NewBlob) isEvent_Data() {}

func (*Event_NewCitation) isEvent_Data() {}
...
const file_activity_v1alpha_activity_proto_rawDesc = "" +
	"\n" +
	"\x1factivity/v1alpha/activity.proto\x12\x19com.seed.activity.v1alpha\x1a\x1fgoogle/protobuf/timestamp.proto\x1a!documents/v3alpha/resources.proto\"\xaa\x02\n" +
	...
	"\x05order\x18\a \x01(\x0e2$.com.seed.activity.v1alpha.FeedOrderR\x05order\"v\n" +
	...
	"\x05Event\x12D\n" +
	"\bnew_blob\x18\x01 \x01(\v2'.com.seed.activity.v1alpha.NewBlobEventH\x00R\anewBlob\x12I\n" +
	"\fnew_citation\x18\x05 \x01(\v2$.com.seed.documents.v3alpha.CitationH\x00R\vnewCitation\x12\x18\n" +
	...
	"\tis_pinned\x18\a \x01(\bR\bisPinned*F\n" +
	"\tFeedOrder\x12\x1b\n" +
	"\x17FEED_ORDER_CLAIMED_TIME\x10\x00\x12\x1c\n" +
	"\x18FEED_ORDER_OBSERVED_TIME\x10\x012y\n" +
	"\fActivityFeed\x12i\n" +
	"\n" +
...
var file_activity_v1alpha_activity_proto_enumTypes = make([]protoimpl.EnumInfo, 1)
...
var file_activity_v1alpha_activity_proto_goTypes = []any{
	(FeedOrder)(0),                // 0: com.seed.activity.v1alpha.FeedOrder
	(*ListEventsRequest)(nil),     // 1: com.seed.activity.v1alpha.ListEventsRequest
	(*ListEventsResponse)(nil),    // 2: com.seed.activity.v1alpha.ListEventsResponse
	(*Event)(nil),                 // 3: com.seed.activity.v1alpha.Event
	(*NewBlobEvent)(nil),          // 4: com.seed.activity.v1alpha.NewBlobEvent
	(*v3alpha.Citation)(nil),      // 5: com.seed.documents.v3alpha.Citation
	(*timestamppb.Timestamp)(nil), // 6: google.protobuf.Timestamp
}
var file_activity_v1alpha_activity_proto_depIdxs = []int32{
	0, // 0: com.seed.activity.v1alpha.ListEventsRequest.order:type_name -> com.seed.activity.v1alpha.FeedOrder
	3, // 1: com.seed.activity.v1alpha.ListEventsResponse.events:type_name -> com.seed.activity.v1alpha.Event
	4, // 2: com.seed.activity.v1alpha.Event.new_blob:type_name -> com.seed.activity.v1alpha.NewBlobEvent
	5, // 3: com.seed.activity.v1alpha.Event.new_citation:type_name -> com.seed.documents.v3alpha.Citation
	6, // 4: com.seed.activity.v1alpha.Event.event_time:type_name -> google.protobuf.Timestamp
	6, // 5: com.seed.activity.v1alpha.Event.observe_time:type_name -> google.protobuf.Timestamp
	1, // 6: com.seed.activity.v1alpha.ActivityFeed.ListEvents:input_type -> com.seed.activity.v1alpha.ListEventsRequest
	2, // 7: com.seed.activity.v1alpha.ActivityFeed.ListEvents:output_type -> com.seed.activity.v1alpha.ListEventsResponse
...
func file_activity_v1alpha_activity_proto_init() {
	...
	out := protoimpl.TypeBuilder{
		...
		EnumInfos:         file_activity_v1alpha_activity_proto_enumTypes,
