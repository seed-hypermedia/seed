...
const (
	Invoices_CreateInvoice_FullMethodName        = "/com.seed.payments.v1alpha.Invoices/CreateInvoice"
	Invoices_PayInvoice_FullMethodName           = "/com.seed.payments.v1alpha.Invoices/PayInvoice"
	Invoices_ListPaidInvoices_FullMethodName     = "/com.seed.payments.v1alpha.Invoices/ListPaidInvoices"
	Invoices_DecodeInvoice_FullMethodName        = "/com.seed.payments.v1alpha.Invoices/DecodeInvoice"
	Invoices_ListReceivedInvoices_FullMethodName = "/com.seed.payments.v1alpha.Invoices/ListReceivedInvoices"
)
...
func (c *invoicesClient) PayInvoice(ctx context.Context, in *PayInvoiceRequest, opts ...grpc.CallOption) (*emptypb.Empty, error) {
	...
	err := c.cc.Invoke(ctx, Invoices_PayInvoice_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *invoicesClient) ListPaidInvoices(ctx context.Context, in *ListInvoicesRequest, opts ...grpc.CallOption) (*ListInvoicesResponse, error) {
	...
	err := c.cc.Invoke(ctx, Invoices_ListPaidInvoices_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *invoicesClient) DecodeInvoice(ctx context.Context, in *DecodeInvoiceRequest, opts ...grpc.CallOption) (*Invoice, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(Invoice)
	err := c.cc.Invoke(ctx, Invoices_DecodeInvoice_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *invoicesClient) ListReceivedInvoices(ctx context.Context, in *ListInvoicesRequest, opts ...grpc.CallOption) (*ListInvoicesResponse, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(ListInvoicesResponse)
	err := c.cc.Invoke(ctx, Invoices_ListReceivedInvoices_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
// UnimplementedInvoicesServer should be embedded to have
...
func _Invoices_PayInvoice_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: Invoices_PayInvoice_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
...
func _Invoices_ListPaidInvoices_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: Invoices_ListPaidInvoices_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
...
func _Invoices_DecodeInvoice_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: Invoices_DecodeInvoice_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
...
func _Invoices_ListReceivedInvoices_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: Invoices_ListReceivedInvoices_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
...
const (
	LNURL_RequestLud6Invoice_FullMethodName = "/com.seed.payments.v1alpha.LNURL/RequestLud6Invoice"
	LNURL_GetLnAddress_FullMethodName       = "/com.seed.payments.v1alpha.LNURL/GetLnAddress"
	LNURL_UpdateLNAddress_FullMethodName    = "/com.seed.payments.v1alpha.LNURL/UpdateLNAddress"
)
...
func (c *lNURLClient) RequestLud6Invoice(ctx context.Context, in *RequestLud6InvoiceRequest, opts ...grpc.CallOption) (*InvoiceResponse, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(InvoiceResponse)
	err := c.cc.Invoke(ctx, LNURL_RequestLud6Invoice_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *lNURLClient) GetLnAddress(ctx context.Context, in *GetLnAddressRequest, opts ...grpc.CallOption) (*LNAddress, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(LNAddress)
	err := c.cc.Invoke(ctx, LNURL_GetLnAddress_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *lNURLClient) UpdateLNAddress(ctx context.Context, in *UpdateLNAddressRequest, opts ...grpc.CallOption) (*LNAddress, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(LNAddress)
	err := c.cc.Invoke(ctx, LNURL_UpdateLNAddress_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
// UnimplementedLNURLServer should be embedded to have
// forward compatible implementations.
//
// NOTE: this should be embedded by value instead of pointer to avoid a nil
// pointer dereference when methods are called.
...
func (UnimplementedLNURLServer) testEmbeddedByValue() {}
...
func RegisterLNURLServer(s grpc.ServiceRegistrar, srv LNURLServer) {
	// If the following call pancis, it indicates UnimplementedLNURLServer was
	// embedded by pointer and is nil.  This will cause panics if an
	// unimplemented method is ever invoked, so we test this at initialization
	// time to prevent it from happening at runtime later due to I/O.
	if t, ok := srv.(interface{ testEmbeddedByValue() }); ok {
...
func _LNURL_RequestLud6Invoice_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: LNURL_RequestLud6Invoice_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
...
func _LNURL_GetLnAddress_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: LNURL_GetLnAddress_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
...
func _LNURL_UpdateLNAddress_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: LNURL_UpdateLNAddress_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
