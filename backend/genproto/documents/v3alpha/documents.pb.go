...
type BuiltinSortAttribute int32

const (
	// No built-in field specified.
	BuiltinSortAttribute_BUILTIN_SORT_ATTRIBUTE_UNSPECIFIED BuiltinSortAttribute = 0
	// Sort by the document name/title.
	BuiltinSortAttribute_BUILTIN_SORT_ATTRIBUTE_NAME BuiltinSortAttribute = 1
	// Sort by the document path.
	BuiltinSortAttribute_BUILTIN_SORT_ATTRIBUTE_PATH BuiltinSortAttribute = 2
	// Sort by document creation time.
	BuiltinSortAttribute_BUILTIN_SORT_ATTRIBUTE_CREATE_TIME BuiltinSortAttribute = 3
	// Sort by document last-update time.
	BuiltinSortAttribute_BUILTIN_SORT_ATTRIBUTE_UPDATE_TIME BuiltinSortAttribute = 4
	// Sort by document activity time (latest comment or change).
	BuiltinSortAttribute_BUILTIN_SORT_ATTRIBUTE_ACTIVITY_TIME BuiltinSortAttribute = 5
	// Sort by the number of comments on the document.
	BuiltinSortAttribute_BUILTIN_SORT_ATTRIBUTE_COMMENT_COUNT BuiltinSortAttribute = 6
)

// Enum value maps for BuiltinSortAttribute.
var (
	BuiltinSortAttribute_name = map[int32]string{
		0: "BUILTIN_SORT_ATTRIBUTE_UNSPECIFIED",
		1: "BUILTIN_SORT_ATTRIBUTE_NAME",
		2: "BUILTIN_SORT_ATTRIBUTE_PATH",
		3: "BUILTIN_SORT_ATTRIBUTE_CREATE_TIME",
		4: "BUILTIN_SORT_ATTRIBUTE_UPDATE_TIME",
		5: "BUILTIN_SORT_ATTRIBUTE_ACTIVITY_TIME",
		6: "BUILTIN_SORT_ATTRIBUTE_COMMENT_COUNT",
	}
	BuiltinSortAttribute_value = map[string]int32{
		"BUILTIN_SORT_ATTRIBUTE_UNSPECIFIED":   0,
		"BUILTIN_SORT_ATTRIBUTE_NAME":          1,
		"BUILTIN_SORT_ATTRIBUTE_PATH":          2,
		"BUILTIN_SORT_ATTRIBUTE_CREATE_TIME":   3,
		"BUILTIN_SORT_ATTRIBUTE_UPDATE_TIME":   4,
		"BUILTIN_SORT_ATTRIBUTE_ACTIVITY_TIME": 5,
		"BUILTIN_SORT_ATTRIBUTE_COMMENT_COUNT": 6,
	}
)

func (x BuiltinSortAttribute) Enum() *BuiltinSortAttribute {
	p := new(BuiltinSortAttribute)
	*p = x
	return p
}

func (x BuiltinSortAttribute) String() string {
	return protoimpl.X.EnumStringOf(x.Descriptor(), protoreflect.EnumNumber(x))
}

func (BuiltinSortAttribute) Descriptor() protoreflect.EnumDescriptor {
	return file_documents_v3alpha_documents_proto_enumTypes[2].Descriptor()
}

func (BuiltinSortAttribute) Type() protoreflect.EnumType {
	return &file_documents_v3alpha_documents_proto_enumTypes[2]
}

func (x BuiltinSortAttribute) Number() protoreflect.EnumNumber {
	return protoreflect.EnumNumber(x)
}

// Deprecated: Use BuiltinSortAttribute.Descriptor instead.
func (BuiltinSortAttribute) EnumDescriptor() ([]byte, []int) {
...
type DocumentSort struct {
	...
	Attribute     BuiltinSortAttribute `protobuf:"varint,3,opt,name=attribute,proto3,enum=com.seed.documents.v3alpha.BuiltinSortAttribute" json:"attribute,omitempty"`
	unknownFields protoimpl.UnknownFields
	sizeCache     protoimpl.SizeCache
}
...
func (x *DocumentSort) GetAttribute() BuiltinSortAttribute {
	if x != nil {
		return x.Attribute
	}
	return BuiltinSortAttribute_BUILTIN_SORT_ATTRIBUTE_UNSPECIFIED
}
...
const file_documents_v3alpha_documents_proto_rawDesc = "" +
	...
	"descending\x18\x02 \x01(\bR\n" +
	"descending\x12N\n" +
	"\tattribute\x18\x03 \x01(\x0e20.com.seed.documents.v3alpha.BuiltinSortAttributeR\tattribute\"\xd5\x01\n" +
	...
	"\x04PATH\x10\x02*\xa4\x02\n" +
	"\x14BuiltinSortAttribute\x12&\n" +
	"\"BUILTIN_SORT_ATTRIBUTE_UNSPECIFIED\x10\x00\x12\x1f\n" +
	"\x1bBUILTIN_SORT_ATTRIBUTE_NAME\x10\x01\x12\x1f\n" +
	"\x1bBUILTIN_SORT_ATTRIBUTE_PATH\x10\x02\x12&\n" +
	"\"BUILTIN_SORT_ATTRIBUTE_CREATE_TIME\x10\x03\x12&\n" +
	"\"BUILTIN_SORT_ATTRIBUTE_UPDATE_TIME\x10\x04\x12(\n" +
	"$BUILTIN_SORT_ATTRIBUTE_ACTIVITY_TIME\x10\x05\x12(\n" +
	"$BUILTIN_SORT_ATTRIBUTE_COMMENT_COUNT\x10\x06*\xcb\x01\n" +
...
var file_documents_v3alpha_documents_proto_depIdxs = []int32{
	...
	2,   // 35: com.seed.documents.v3alpha.DocumentSort.attribute:type_name -> com.seed.documents.v3alpha.BuiltinSortAttribute
	37,  // 36: com.seed.documents.v3alpha.QueryDocumentsRequest.filter:type_name -> com.seed.documents.v3alpha.DocumentFilter
	38,  // 37: com.seed.documents.v3alpha.QueryDocumentsRequest.sort:type_name -> com.seed.documents.v3alpha.DocumentSort
	57,  // 38: com.seed.documents.v3alpha.QueryDocumentsResponse.documents:type_name -> com.seed.documents.v3alpha.DocumentInfo
	3,   // 39: com.seed.documents.v3alpha.DocumentAttributeKindUsage.kind:type_name -> com.seed.documents.v3alpha.DocumentAttributeKind
	41,  // 40: com.seed.documents.v3alpha.DocumentAttributeName.kinds:type_name -> com.seed.documents.v3alpha.DocumentAttributeKindUsage
	43,  // 41: com.seed.documents.v3alpha.ListDocumentAttributeNamesResponse.names:type_name -> com.seed.documents.v3alpha.DocumentAttributeName
	3,   // 42: com.seed.documents.v3alpha.ListDocumentAttributeValuesRequest.kind:type_name -> com.seed.documents.v3alpha.DocumentAttributeKind
	36,  // 43: com.seed.documents.v3alpha.DocumentAttributeValue.value:type_name -> com.seed.documents.v3alpha.AttributeValue
	46,  // 44: com.seed.documents.v3alpha.ListDocumentAttributeValuesResponse.values:type_name -> com.seed.documents.v3alpha.DocumentAttributeValue
	56,  // 45: com.seed.documents.v3alpha.ListDocumentChangesResponse.changes:type_name -> com.seed.documents.v3alpha.DocumentChangeInfo
	67,  // 46: com.seed.documents.v3alpha.CreateRefRequest.target:type_name -> com.seed.documents.v3alpha.RefTarget
	87,  // 47: com.seed.documents.v3alpha.CreateRefRequest.timestamp:type_name -> google.protobuf.Timestamp
	0,   // 48: com.seed.documents.v3alpha.CreateRefRequest.visibility:type_name -> com.seed.documents.v3alpha.ResourceVisibility
	66,  // 49: com.seed.documents.v3alpha.ListRefsResponse.refs:type_name -> com.seed.documents.v3alpha.Ref
	87,  // 50: com.seed.documents.v3alpha.DocumentChangeInfo.create_time:type_name -> google.protobuf.Timestamp
	86,  // 51: com.seed.documents.v3alpha.DocumentInfo.metadata:type_name -> google.protobuf.Struct
	87,  // 52: com.seed.documents.v3alpha.DocumentInfo.create_time:type_name -> google.protobuf.Timestamp
	87,  // 53: com.seed.documents.v3alpha.DocumentInfo.update_time:type_name -> google.protobuf.Timestamp
	60,  // 54: com.seed.documents.v3alpha.DocumentInfo.breadcrumbs:type_name -> com.seed.documents.v3alpha.Breadcrumb
	59,  // 55: com.seed.documents.v3alpha.DocumentInfo.activity_summary:type_name -> com.seed.documents.v3alpha.ActivitySummary
	58,  // 56: com.seed.documents.v3alpha.DocumentInfo.generation_info:type_name -> com.seed.documents.v3alpha.GenerationInfo
	84,  // 57: com.seed.documents.v3alpha.DocumentInfo.redirect_info:type_name -> com.seed.documents.v3alpha.RefTarget.Redirect
	0,   // 58: com.seed.documents.v3alpha.DocumentInfo.visibility:type_name -> com.seed.documents.v3alpha.ResourceVisibility
