...
func (x *GetInteractionSummaryRequest) Reset() {
	*x = GetInteractionSummaryRequest{}
	mi := &file_documents_v3alpha_resources_proto_msgTypes[3]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}

func (x *GetInteractionSummaryRequest) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*GetInteractionSummaryRequest) ProtoMessage() {}

func (x *GetInteractionSummaryRequest) ProtoReflect() protoreflect.Message {
	mi := &file_documents_v3alpha_resources_proto_msgTypes[3]
	if x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use GetInteractionSummaryRequest.ProtoReflect.Descriptor instead.
func (*GetInteractionSummaryRequest) Descriptor() ([]byte, []int) {
	return file_documents_v3alpha_resources_proto_rawDescGZIP(), []int{3}
}

func (x *GetInteractionSummaryRequest) GetIri() string {
	if x != nil {
		return x.Iri
	}
	return ""
...
type InteractionSummary struct {
	...
	CitationCount int32 `protobuf:"varint,1,opt,name=citation_count,json=citationCount,proto3" json:"citation_count,omitempty"`
	...
	Blocks []*InteractionSummaryBlock `protobuf:"bytes,3,rep,name=blocks,proto3" json:"blocks,omitempty"`
	// Distinct account IDs that authored citations or comments.
	AuthorUids    []string `protobuf:"bytes,4,rep,name=author_uids,json=authorUids,proto3" json:"author_uids,omitempty"`
	unknownFields protoimpl.UnknownFields
	sizeCache     protoimpl.SizeCache
}

func (x *InteractionSummary) Reset() {
	*x = InteractionSummary{}
	mi := &file_documents_v3alpha_resources_proto_msgTypes[4]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}

func (x *InteractionSummary) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*InteractionSummary) ProtoMessage() {}

func (x *InteractionSummary) ProtoReflect() protoreflect.Message {
	mi := &file_documents_v3alpha_resources_proto_msgTypes[4]
	if x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use InteractionSummary.ProtoReflect.Descriptor instead.
func (*InteractionSummary) Descriptor() ([]byte, []int) {
	return file_documents_v3alpha_resources_proto_rawDescGZIP(), []int{4}
}

func (x *InteractionSummary) GetCitationCount() int32 {
	if x != nil {
...
func (x *InteractionSummary) GetCommentCount() int32 {
	if x != nil {
...
func (x *InteractionSummary) GetBlocks() []*InteractionSummaryBlock {
	if x != nil {
		return x.Blocks
	}
	return nil
...
func (x *InteractionSummary) GetAuthorUids() []string {
	if x != nil {
		return x.AuthorUids
	}
	return nil
...
type InteractionSummaryBlock struct {
	state          protoimpl.MessageState `protogen:"open.v1"`
	TargetFragment string                 `protobuf:"bytes,1,opt,name=target_fragment,json=targetFragment,proto3" json:"target_fragment,omitempty"`
	CitationCount  int32                  `protobuf:"varint,2,opt,name=citation_count,json=citationCount,proto3" json:"citation_count,omitempty"`
	CommentCount   int32                  `protobuf:"varint,3,opt,name=comment_count,json=commentCount,proto3" json:"comment_count,omitempty"`
	unknownFields  protoimpl.UnknownFields
	sizeCache      protoimpl.SizeCache
}

func (x *InteractionSummaryBlock) Reset() {
	*x = InteractionSummaryBlock{}
	mi := &file_documents_v3alpha_resources_proto_msgTypes[5]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}

func (x *InteractionSummaryBlock) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*InteractionSummaryBlock) ProtoMessage() {}

func (x *InteractionSummaryBlock) ProtoReflect() protoreflect.Message {
	mi := &file_documents_v3alpha_resources_proto_msgTypes[5]
	if x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use InteractionSummaryBlock.ProtoReflect.Descriptor instead.
func (*InteractionSummaryBlock) Descriptor() ([]byte, []int) {
	return file_documents_v3alpha_resources_proto_rawDescGZIP(), []int{5}
}

func (x *InteractionSummaryBlock) GetTargetFragment() string {
	if x != nil {
...
func (x *InteractionSummaryBlock) GetCitationCount() int32 {
	if x != nil {
		return x.CitationCount
	}
	return 0
...
func (x *InteractionSummaryBlock) GetCommentCount() int32 {
	if x != nil {
		return x.CommentCount
	}
	return 0
...
func (*Citation_BlobInfo) Descriptor() ([]byte, []int) {
	return file_documents_v3alpha_resources_proto_rawDescGZIP(), []int{8, 0}
}
...
const file_documents_v3alpha_resources_proto_rawDesc = "" +
	...
	"\trecursive\x18\x03 \x01(\bR\trecursive\"0\n" +
	"\x1cGetInteractionSummaryRequest\x12\x10\n" +
	"\x03iri\x18\x01 \x01(\tR\x03iri\"\xce\x01\n" +
	"\x12InteractionSummary\x12%\n" +
	"\x0ecitation_count\x18\x01 \x01(\x05R\rcitationCount\x12#\n" +
	"\rcomment_count\x18\x02 \x01(\x05R\fcommentCount\x12K\n" +
	"\x06blocks\x18\x03 \x03(\v23.com.seed.documents.v3alpha.InteractionSummaryBlockR\x06blocks\x12\x1f\n" +
	"\vauthor_uids\x18\x04 \x03(\tR\n" +
	"authorUids\"\x8e\x01\n" +
	"\x17InteractionSummaryBlock\x12'\n" +
	"\x0ftarget_fragment\x18\x01 \x01(\tR\x0etargetFragment\x12%\n" +
	"\x0ecitation_count\x18\x02 \x01(\x05R\rcitationCount\x12#\n" +
	"\rcomment_count\x18\x03 \x01(\x05R\fcommentCount\"\x89\x01\n" +
	...
	"\rListCitations\x120.com.seed.documents.v3alpha.ListCitationsRequest\x1a1.com.seed.documents.v3alpha.ListCitationsResponse\x12\x81\x01\n" +
	"\x15GetInteractionSummary\x128.com.seed.documents.v3alpha.GetInteractionSummaryRequest\x1a..com.seed.documents.v3alpha.InteractionSummary\x12|\n" +
...
var file_documents_v3alpha_resources_proto_msgTypes = make([]protoimpl.MessageInfo, 10)
var file_documents_v3alpha_resources_proto_goTypes = []any{
	...
	(*GetInteractionSummaryRequest)(nil),  // 3: com.seed.documents.v3alpha.GetInteractionSummaryRequest
	(*InteractionSummary)(nil),            // 4: com.seed.documents.v3alpha.InteractionSummary
	(*InteractionSummaryBlock)(nil),       // 5: com.seed.documents.v3alpha.InteractionSummaryBlock
	...
	(*Citation_BlobInfo)(nil),             // 9: com.seed.documents.v3alpha.Citation.BlobInfo
	(*Document)(nil),                      // 10: com.seed.documents.v3alpha.Document
	(*Comment)(nil),                       // 11: com.seed.documents.v3alpha.Comment
	(*Contact)(nil),                       // 12: com.seed.documents.v3alpha.Contact
	(*timestamppb.Timestamp)(nil),         // 13: google.protobuf.Timestamp
	(*v1alpha.AnnounceBlobsProgress)(nil), // 14: com.seed.p2p.v1alpha.AnnounceBlobsProgress
}
var file_documents_v3alpha_resources_proto_depIdxs = []int32{
	10, // 0: com.seed.documents.v3alpha.Resource.document:type_name -> com.seed.documents.v3alpha.Document
	11, // 1: com.seed.documents.v3alpha.Resource.comment:type_name -> com.seed.documents.v3alpha.Comment
	12, // 2: com.seed.documents.v3alpha.Resource.contact:type_name -> com.seed.documents.v3alpha.Contact
	5,  // 3: com.seed.documents.v3alpha.InteractionSummary.blocks:type_name -> com.seed.documents.v3alpha.InteractionSummaryBlock
	8,  // 4: com.seed.documents.v3alpha.ListCitationsResponse.citations:type_name -> com.seed.documents.v3alpha.Citation
	9,  // 5: com.seed.documents.v3alpha.Citation.source_blob:type_name -> com.seed.documents.v3alpha.Citation.BlobInfo
	13, // 6: com.seed.documents.v3alpha.Citation.BlobInfo.create_time:type_name -> google.protobuf.Timestamp
	0,  // 7: com.seed.documents.v3alpha.Resources.GetResource:input_type -> com.seed.documents.v3alpha.GetResourceRequest
	6,  // 8: com.seed.documents.v3alpha.Resources.ListCitations:input_type -> com.seed.documents.v3alpha.ListCitationsRequest
	3,  // 9: com.seed.documents.v3alpha.Resources.GetInteractionSummary:input_type -> com.seed.documents.v3alpha.GetInteractionSummaryRequest
	2,  // 10: com.seed.documents.v3alpha.Resources.PushResourcesToPeer:input_type -> com.seed.documents.v3alpha.PushResourcesToPeerRequest
	1,  // 11: com.seed.documents.v3alpha.Resources.GetResource:output_type -> com.seed.documents.v3alpha.Resource
	7,  // 12: com.seed.documents.v3alpha.Resources.ListCitations:output_type -> com.seed.documents.v3alpha.ListCitationsResponse
	4,  // 13: com.seed.documents.v3alpha.Resources.GetInteractionSummary:output_type -> com.seed.documents.v3alpha.InteractionSummary
	14, // 14: com.seed.documents.v3alpha.Resources.PushResourcesToPeer:output_type -> com.seed.p2p.v1alpha.AnnounceBlobsProgress
