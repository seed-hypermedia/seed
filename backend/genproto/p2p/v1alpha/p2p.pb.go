...
const file_p2p_v1alpha_p2p_proto_rawDesc = "" +
	"\n" +
	"\x15p2p/v1alpha/p2p.proto\x12\x14com.seed.p2p.v1alpha\x1a\x1fgoogle/protobuf/timestamp.proto\"*\n" +
	...
	"\tlist_hash\x18\x03 \x01(\tR\blistHash\"O\n" +
	"\x11ListSpacesRequest\x12\x1b\n" +
	"\tpage_size\x18\x01 \x01(\x05R\bpageSize\x12\x1d\n" +
	"\n" +
	"page_token\x18\x02 \x01(\tR\tpageToken\"~\n" +
	"\x12ListSpacesResponse\x12\x16\n" +
	"\x06spaces\x18\x01 \x03(\tR\x06spaces\x12&\n" +
	"\x0fnext_page_token\x18\x02 \x01(\tR\rnextPageToken\x12(\n" +
	"\x10has_more_results\x18\x03 \x01(\bR\x0ehasMoreResults\"\xae\x01\n" +
	"\x15RequestInvoiceRequest\x12\x1f\n" +
	"\vamount_sats\x18\x01 \x01(\x03R\n" +
	"amountSats\x12\x18\n" +
	"\aaccount\x18\x02 \x01(\tR\aaccount\x12\x12\n" +
	"\x04memo\x18\x03 \x01(\tR\x04memo\x12!\n" +
	"\fhold_invoice\x18\x04 \x01(\bR\vholdInvoice\x12#\n" +
	"\rpreimage_hash\x18\x05 \x01(\fR\fpreimageHash\"1\n" +
	"\x16RequestInvoiceResponse\x12\x17\n" +
	...
	"\x05addrs\x18\x02 \x03(\tR\x05addrs\x12S\n" +
	"\x11connection_status\x18\x03 \x01(\x0e2&.com.seed.p2p.v1alpha.ConnectionStatusR\x10connectionStatus\x129\n" +
	"\n" +
...
var (
	...
	file_p2p_v1alpha_p2p_proto_rawDescData []byte
)

func file_p2p_v1alpha_p2p_proto_rawDescGZIP() []byte {
	file_p2p_v1alpha_p2p_proto_rawDescOnce.Do(func() {
		file_p2p_v1alpha_p2p_proto_rawDescData = protoimpl.X.CompressGZIP(unsafe.Slice(unsafe.StringData(file_p2p_v1alpha_p2p_proto_rawDesc), len(file_p2p_v1alpha_p2p_proto_rawDesc)))
	})
