...
type DiscoverEntityRequest struct {
	...
	BlobTypes     []string `protobuf:"bytes,5,rep,name=blob_types,json=blobTypes,proto3" json:"blob_types,omitempty"`
	unknownFields protoimpl.UnknownFields
	sizeCache     protoimpl.SizeCache
}
...
func (x *DiscoverEntityRequest) GetBlobTypes() []string {
	if x != nil {
		return x.BlobTypes
	}
	return nil
...
const file_entities_v1alpha_entities_proto_rawDesc = "" +
	...
	"\x0einclude_drafts\x18\x02 \x01(\bR\rincludeDrafts\"\x9c\x01\n" +
	"\x15DiscoverEntityRequest\x12\x18\n" +
	"\aaccount\x18\x01 \x01(\tR\aaccount\x12\x12\n" +
	"\x04path\x18\x02 \x01(\tR\x04path\x12\x18\n" +
	"\aversion\x18\x03 \x01(\tR\aversion\x12\x1c\n" +
	"\trecursive\x18\x04 \x01(\bR\trecursive\x12\x1d\n" +
	"\n" +
	"blob_types\x18\x05 \x03(\tR\tblobTypes\"\xf6\x02\n" +
