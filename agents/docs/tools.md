...
refused (models put them there constantly; a refusal costs a whole retry turn). Available to a foreground conversation with a live run; never to a delegated child (typed or
