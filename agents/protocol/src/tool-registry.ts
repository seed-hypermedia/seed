  ...
  inputSchema: {
    ...
    properties: {
      ...
      prompt: {
        type: 'string',
        description:
          'Model child: optional system prompt for an anonymous worker using your model. Omit to run the child as yourself.',
      },
      model: {
        type: 'string',
        description:
