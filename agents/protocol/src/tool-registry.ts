...
const readVerb = {
  ...
  description: [
    ...
    '- `hm://…` (or a Seed gateway/space URL) — a hypermedia document or comment, as markdown by default. Append `/:directory` to list the child documents under an account or document; `/:attributes` for metadata only; `/:profile` on an account for its profile.',
