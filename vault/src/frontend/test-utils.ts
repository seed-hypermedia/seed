...
export function createMockClient(overrides: Partial<api.ClientInterface> = {}): api.ClientInterface {
	...
	return {
		...
		registerComplete: notImplemented("registerComplete"),
		registerCompletePasskey: notImplemented("registerCompletePasskey"),
...
export function createSuccessMockClient(overrides: Partial<api.ClientInterface> = {}): api.ClientInterface {
	return {
		...
		registerComplete: async () => ({ success: true, userId: "user-1" }),
		registerCompletePasskey: async () => ({ success: true, userId: "user-1" }),
