...
schemaDefinition: ipfs://bafyreic6rle2f7nwczasmoda7wkhuoivql3joarhnbhouqaodott3i5nze
---
...
A **closed struct** with these fields: <!-- id:UieRV9uL -->
  - `name` _(required)_ — [string](./hypermedia-string.md) <!-- id:c1M-6Hil -->
...
- [string](./hypermedia-string.md) <!-- id:i0I8j29E -->
