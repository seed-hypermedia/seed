...
schemaDefinition: ipfs://bafyreibh4mx7gjwo2fh6fsk7dfsxp6xgda5xjbz7gas2v4pixmoebaoufi
---
...
A **closed struct** with these fields: <!-- id:ugdqxq2C -->
  - `id` _(required)_ — [string](./hypermedia-string.md) <!-- id:aqCipWke -->
  - `subject` _(required)_ — [string](./hypermedia-string.md) <!-- id:bMulhxTe -->
  - `name` _(required)_ — [string](./hypermedia-string.md) <!-- id:KYAzDSpX -->
  - `account` _(required)_ — [string](./hypermedia-string.md) <!-- id:mkd9FU0y -->
  - `signer` _(required)_ — [string](./hypermedia-string.md) <!-- id:ayR30qBL -->
...
- [string](./hypermedia-string.md) <!-- id:gMda6qOD -->
