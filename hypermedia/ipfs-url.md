...
- [cid](./cid.md): the content identifier inside the URL.
- [url](./url.md) and [hm-url](./hm-url.md): the other URL types.
- [metadata](./metadata.md): `icon`, `cover` and `schemaDefinition` hold this type.
