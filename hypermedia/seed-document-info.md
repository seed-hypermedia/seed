...
A **closed struct** with these fields: <!-- id:JQCMU3uI -->
  ...
  - `sortTime` _(required)_ — [string](./hypermedia-string.md) <!-- id:JIjiRvAQ -->
  - `genesis` _(required)_ — [string](./hypermedia-string.md) <!-- id:Z1kajVwn -->
  - `version` _(required)_ — [string](./hypermedia-string.md) <!-- id:M6ZV22FP -->
  ...
  - `firstImageInContent` — [string](./hypermedia-string.md) <!-- id:5w2RRbrg -->
...
- [integer](./hypermedia-integer.md) <!-- id:9guKeYjp -->
- [string](./hypermedia-string.md) <!-- id:f4Izt9d_ -->
