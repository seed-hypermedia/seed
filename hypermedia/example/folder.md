...
schemaDefinition: ipfs://bafyreifweql2ejhrhm7s2cahfgupcfgrtpqfzby4zwtdty3dlthwx7pq44
---
...
A **closed struct** with these fields: <!-- id:UieRV9uL -->
  - `name` _(required)_ — [string](../schema/string.md) <!-- id:c1M-6Hil -->
...
- [string](../schema/string.md) <!-- id:i0I8j29E -->
