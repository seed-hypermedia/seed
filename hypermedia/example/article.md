...
# See also <!-- id:uGsQuewm -->

- [Link](../link.md): typed links between values. <!-- id:cu81e9kg -->
- [status](./status.md): the status union. <!-- id:0frmQXTk -->
- [person](./person.md): the author type. <!-- id:1dB3sroG -->
- [Examples](../example.md): every example, grouped by feature. <!-- id:lW_6U-hv -->
