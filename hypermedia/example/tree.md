...
schemaDefinition: ipfs://bafyreibcno2jjhxibsfyvttkjro47dmh2cax2ennz5qm6nxpgavryjro6e
---
...
A **closed struct** with these fields: <!-- id:yQtqZKJv -->
  - `value` _(required)_ — [integer](../schema/integer.md) <!-- id:3BtaYYI8 -->
  - `children` — list of `link` → [example/tree](./tree.md) <!-- id:VRg-fWag -->

# Depends on <!-- id:j7V1B1aL -->

- [integer](../schema/integer.md) <!-- id:G7JqZKJV -->
