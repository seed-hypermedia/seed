...
schemaDefinition: ipfs://bafyreif7n7uxnzbbbsujh44pruueivvfozbqobclrdoid4dn75tv6wcgui
---
...
A **closed struct** with these fields: <!-- id:fuIZuu-D -->
  - `title` _(required)_ — [string](./hypermedia-string.md) <!-- id:idLG8YKz -->
  - `author` — `link` → [example-person](./example-person.md) <!-- id:ja_Lj9E4 -->
  - `body` — [bytes](./hypermedia-bytes.md) <!-- id:VeUW9ia0 -->
...
- [bytes](./hypermedia-bytes.md) <!-- id:WFEB7HHQ -->
- [string](./hypermedia-string.md) <!-- id:NfuhhcxV -->
