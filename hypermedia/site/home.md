...
New to Onyx? These four pages explain the system from the top down before the reference chapters go deep: <!-- id:XwK2BBFL -->
  - [Why Onyx](hm://z6MkmZUb4K5c17zGGBuJJerwFzBaGkiYLfEEnkb9CH1W1ptb/why) — the problem it solves, what it makes possible, and what it deliberately is not. <!-- id:ASDj0A2q -->
  - [How Onyx works](hm://z6MkmZUb4K5c17zGGBuJJerwFzBaGkiYLfEEnkb9CH1W1ptb/how-it-works) — the whole pipeline, from a schema file to a signed blob, a browsable document, a resolved reference, a generated type, and a typed API call. <!-- id:JnOo7Tmo -->
  - [Typed documents](hm://z6MkmZUb4K5c17zGGBuJJerwFzBaGkiYLfEEnkb9CH1W1ptb/typed-documents) — how a document declares what it is with `schema`, `childrenSchema`, and `schemaDefinition`, and what the editor does about it. <!-- id:ejnPERZF -->
  - [The World Builder](hm://z6MkmZUb4K5c17zGGBuJJerwFzBaGkiYLfEEnkb9CH1W1ptb/world-builder) — a worked demo: scaffold an ontology of types that reference each other, with date pickers, title pills, and linked objects in every page. <!-- id:JKC7fUPx -->
  - [The typed API](hm://z6MkmZUb4K5c17zGGBuJJerwFzBaGkiYLfEEnkb9CH1W1ptb/api) — every read method of the Seed API as a published schema, and the console generated from them. <!-- id:gnB4WgGS -->
...
The concepts, in reading order: <!-- id:MLxtm7My -->
  1. [The data model](hm://z6MkmZUb4K5c17zGGBuJJerwFzBaGkiYLfEEnkb9CH1W1ptb/data-model) — the nine kinds of value. <!-- id:_5H16K85 -->
  2. [The schema language](hm://z6MkmZUb4K5c17zGGBuJJerwFzBaGkiYLfEEnkb9CH1W1ptb/schema-language) — the full vocabulary: closed maps, unions, generics, extension, value constraints, and how Onyx describes itself. <!-- id:dS1O-Jw6 -->
  3. [References & naming](hm://z6MkmZUb4K5c17zGGBuJJerwFzBaGkiYLfEEnkb9CH1W1ptb/references) — include / typed link / extend, `hm://` names, and why names (not hashes) make recursion possible. <!-- id:W-7l34pY -->
  4. [Encoding](hm://z6MkmZUb4K5c17zGGBuJJerwFzBaGkiYLfEEnkb9CH1W1ptb/encoding) — DAG-CBOR, the `dag-json` human form, canonical encoding, and the reserved-key envelopes. <!-- id:zc8wCFCX -->
  5. [Examples](hm://z6MkmZUb4K5c17zGGBuJJerwFzBaGkiYLfEEnkb9CH1W1ptb/examples) — a catalog of every example schema, grouped by feature. <!-- id:nslzTd6Z -->
  6. [Onyx on the Hypermedia Network](hm://z6MkmZUb4K5c17zGGBuJJerwFzBaGkiYLfEEnkb9CH1W1ptb/hypermedia) — schemas for the network's real DAG-CBOR blobs (Change, Ref, Profile, …), the full block model including [tables](hm://z6MkmZUb4K5c17zGGBuJJerwFzBaGkiYLfEEnkb9CH1W1ptb/hypermedia-block-table) and [live queries](hm://z6MkmZUb4K5c17zGGBuJJerwFzBaGkiYLfEEnkb9CH1W1ptb/hypermedia-block-query), and the `seed-*` read models — the derived data the daemon computes for clients (resources, [citations](hm://z6MkmZUb4K5c17zGGBuJJerwFzBaGkiYLfEEnkb9CH1W1ptb/seed-citation), [search results](hm://z6MkmZUb4K5c17zGGBuJJerwFzBaGkiYLfEEnkb9CH1W1ptb/seed-search-results), …). <!-- id:SZlHsPnT -->
  7. [Design rationale](hm://z6MkmZUb4K5c17zGGBuJJerwFzBaGkiYLfEEnkb9CH1W1ptb/design) — why the system is shaped this way, the decisions taken, and the open questions. <!-- id:ZHSf8L5M -->
