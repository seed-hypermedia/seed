...
---
**Onyx** — the self-describing type system defined in this directory. <!-- id:KM38ltwU -->
...
New to Onyx? These four pages explain the system from the top down before the reference chapters go deep: <!-- id:XwK2BBFL -->
  - [Why Onyx](./doc/schema/why.md) — the problem it solves, what it makes possible, and what it deliberately is not. <!-- id:ASDj0A2q -->
  - [How Onyx works](./doc/schema/how-it-works.md) — the whole pipeline, from a schema file to a signed blob, a browsable document, a resolved reference, a generated type, and a typed API call. <!-- id:JnOo7Tmo -->
  ...
  - [The World Builder](./example/world-builder.md) — a worked demo: scaffold an ontology of types that reference each other, with date pickers, title pills, and linked objects in every page. <!-- id:JKC7fUPx -->
...
The concepts, in reading order: <!-- id:MLxtm7My -->
  ...
  2. [The schema language](./schema/schema-language.md) — the full vocabulary: closed maps, unions, generics, extension, value constraints, and how Onyx describes itself. <!-- id:dS1O-Jw6 -->
  ...
  8. [Glossary](./schema.md) — every term in one place. <!-- id:lZdOYrQc -->
