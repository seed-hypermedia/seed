...
schemaDefinition: ipfs://bafyreih6f4ucbuaa4t2wihxw72nvvmjezfnpa3r2kq75dbt6cmmcwdmcwy
---
...
This document describes the **rpc/get-cid** type — a Seed API read-model schema (derived data the daemon computes for clients, not a signed network blob). Its formal schema is attached (the `schemaDefinition` in this document's metadata), so the app can show it and create values of this type. <!-- id:rPC2zBYZ -->
...
- [any](../schema/any.md) <!-- id:xxcRpn4k -->
- [string](../schema/string.md) <!-- id:rLVe6evY -->
