...
This document describes the **rpc/type/activity-event** type — a Seed API read-model schema (derived data the daemon computes for clients, not a signed network blob). Its formal schema is attached (the `schemaDefinition` in this document's metadata), so the app can show it and create values of this type. <!-- id:ZYDbAobO -->

# Shape <!-- id:jk2YPQ-- -->

An **open map** — every value: [any](../../schema/any.md). <!-- id:sBIDM6B6 -->

# Depends on <!-- id:ZdlPpe18 -->

- [any](../../schema/any.md) <!-- id:sc0AkmF_ -->
