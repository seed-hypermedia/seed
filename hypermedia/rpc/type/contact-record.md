...
A **closed struct** with these fields: <!-- id:ugdqxq2C -->
  - `id` _(required)_ — [string](../../schema/string.md) <!-- id:aqCipWke -->
  - `subject` _(required)_ — [string](../../schema/string.md) <!-- id:bMulhxTe -->
  - `name` _(required)_ — [string](../../schema/string.md) <!-- id:KYAzDSpX -->
  - `account` _(required)_ — [string](../../schema/string.md) <!-- id:mkd9FU0y -->
  - `signer` _(required)_ — [string](../../schema/string.md) <!-- id:ayR30qBL -->
  - `createTime` — [schema/timestamp](../../schema/timestamp.md) <!-- id:oIDm5uXY -->
  - `updateTime` — [schema/timestamp](../../schema/timestamp.md) <!-- id:onjq-D5J -->
  - `subscribe` — [schema/contact-subscribe](../../schema/contact-subscribe.md) <!-- id:sD_jerc- -->

# Depends on <!-- id:1vh3aSIz -->

- [schema/contact-subscribe](../../schema/contact-subscribe.md) <!-- id:iqkqluZP -->
- [schema/timestamp](../../schema/timestamp.md) <!-- id:CYoLI_wb -->
- [string](../../schema/string.md) <!-- id:gMda6qOD -->
