...
A **closed struct** with these fields: <!-- id:H9UhYokL -->
  ...
  - `target` _(required)_ — [string](../../schema/string.md) <!-- id:yhCOxGRG -->
  - `republish` — [boolean](../../schema/boolean.md) <!-- id:jjdxxctm -->

# Depends on <!-- id:uX4Hsf16 -->

- [boolean](../../schema/boolean.md) <!-- id:ViQ8FoIh -->
- [string](../../schema/string.md) <!-- id:uzKMxK4F -->
