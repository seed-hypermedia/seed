...
schemaDefinition: ipfs://bafyreicfesm67nzr2tkl7qaszy7n7j4rptlvsaunx3oi2o4rj543et3xe4
---
...
A **closed struct** with these fields: <!-- id:qq18fyuR -->
  ...
  - `authorUids` — list of [string](./hypermedia-string.md) <!-- id:h7HlbaFp -->

# Depends on <!-- id:sjAu9-Sn -->

- [string](./hypermedia-string.md) <!-- id:5lfnuo9f -->
