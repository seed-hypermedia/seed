...
This page describes the **hm-url** type — a value type of Hypermedia Schemas. Its formal schema is attached (the `schemaDefinition` in this document's metadata), so the app can show it and create values of this type. <!-- id:G6hl5zLM -->
