...
schemaDefinition: ipfs://bafyreifi7ynw7utenobmdu4b6a54rmdw3wn26v53fucusrdhukodb5cdoa
---
...
This document describes the **schema/date** type — a schema. Its formal schema is attached (the `schemaDefinition` in this document's metadata), so the app can show it and create values of this type. <!-- id:qoiuf7ZN -->
