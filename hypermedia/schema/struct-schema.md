...
- [Property](./property.md): one field of a struct.
- [Closed map](./closed-map.md): what happens to keys a struct does not name.
- [Map schema](./map-schema.md): arbitrary keys with one value type.
- [Extension](./extension.md): a struct that builds on a parent.
- [Typed documents](./typed-documents.md): how a document names the schema of its attributes.
