...
schemaDefinition: ipfs://bafyreidrang7oje74p56kwa2fcbfqhb4ckijwws5nakngbfb47zv4jdxvm
---
This document describes the **schema/any** type — a primitive. Its formal schema is attached (the `schemaDefinition` in this document's metadata), so the app can show it and create values of this type. <!-- id:oO6eJaVw -->
