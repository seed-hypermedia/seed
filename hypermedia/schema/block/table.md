...
This document describes the **schema/block/table** type — a Hypermedia Network blob schema. Its formal schema is attached (the `schemaDefinition` in this document's metadata), so the app can show it and create values of this type. <!-- id:H3fdehxc -->

# Shape <!-- id:axji3Nx3 -->

**Extends** [schema/block/base](./base.md) with these added fields: <!-- id:WAdLuZ1t -->
  - `type` — `"Table"` <!-- id:OIXFENDr -->
  - `attributes` — map { 2 fields } <!-- id:1Ug72bRZ -->

# Depends on <!-- id:AgnaGp59 -->

- [schema/block/base](./base.md) <!-- id:fu5elJWe -->
- [schema/block/children-type](./children-type.md) <!-- id:hg7kQizu -->
