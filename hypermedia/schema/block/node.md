...
schemaDefinition: ipfs://bafyreiasfkk43xkgnuq6cdhjvjpegegoxaethj45lytpsepxy4m6dsauxq
---
...
This document describes the **schema/block/node** type — a Hypermedia Network blob schema. Its formal schema is attached (the `schemaDefinition` in this document's metadata), so the app can show it and create values of this type. <!-- id:4_Z0qDWP -->

# Shape <!-- id:RgXO3NxT -->

A **closed struct** with these fields: <!-- id:LM850y9F -->
  - `block` _(required)_ — [block](../../block.md) <!-- id:SwY5yaNk -->
  - `children` — list of [schema/block/node](./node.md) <!-- id:5Kul9cSX -->
