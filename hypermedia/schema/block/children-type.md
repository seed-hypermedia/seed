...
---
This document describes the **schema/block/children-type** type — a Hypermedia Network blob schema. Its formal schema is attached (the `schemaDefinition` in this document's metadata), so the app can show it and create values of this type. <!-- id:Oh03LfF- -->
