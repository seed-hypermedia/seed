...
- `{type: X}` alone **[includes](./include-schema.md)** X. `{type: X, properties: …}` **[extends](./extension.md)** it: the parent's fields plus new ones, closedness kept. `{allOf: [{type: X}, {type: Y}]}` is the **[intersection](./allof.md)**: X and Y merged into one struct, a subtype of both. <!-- id:3s1dFPYn -->
