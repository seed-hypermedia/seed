...
---
A var schema is a type variable inside a [generic](./generic.md). It matches whatever schema the generic's parameter is bound to.
...
- [Generic](./generic.md): `params`, `var` and `args` together.
- [Change](../change.md): `Change<Block>` is the library's generic.
