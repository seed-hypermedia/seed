...
schemaDefinition: ipfs://bafyreihtbx4w2ku7n5apfzniwrt5tgaoxmbkn4jzkiwxhb7mehilb2ym6m
---
...
This document describes the **schema/ipfs** type — a Hypermedia Network blob schema. Its formal schema is attached (the `schemaDefinition` in this document's metadata), so the app can show it and create values of this type. <!-- id:yxkmJOet -->
