...
- [Union schema](./anyof.md): the `anyOf` keyword.
- [Literal schema](./literal-schema.md): the `type` tag of each blob is a literal.
- [Blob](../blob.md): signed blobs form a discriminated union on `type`.
