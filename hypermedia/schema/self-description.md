...
summary: "the property that the meta-schema is a valid instance of itself: `schema` matches its own `union` variant, whose `anyOf` items match its `include` variant, whose targets match the other…"
---
