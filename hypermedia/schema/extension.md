...
`{ "type": "hyper.media/example/person", "properties": {…} }` <!-- id:vG52Mjgo -->

A subtype: the parent's fields plus the new ones, each a property that says whether it is required. <!-- id:lJDeDmj1 -->

No `extends` keyword — `type` names the parent, and the presence of any other key is what distinguishes an extension from a bare <hm://z6MkoAVbUvhqBBkJ8CU9aDhn13UUu4UePixQdPFYumn5gsW3/schema/include-schema?v=bafyreihrqa5xrgzfbv73mbghzomjt3uz6axvhatocfi7gjr3hprpqwltuq&l>. <!-- id:drnWeK9F -->
