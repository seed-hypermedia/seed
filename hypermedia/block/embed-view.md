...
- [block/embed](./embed.md): the block that uses this value. <!-- id:MRbvFJh0 -->
- [Blocks](../protocol/blocks.md): embeds in the block model. <!-- id:4u1QOhz6 -->
- [URLs](../protocol/urls.md): what an embed can point at. <!-- id:IH5x_bwC -->
