...
- [block/table-column](./table-column.md): a column marker.
- [block/paragraph](./paragraph.md): the cell block.
- [Blocks](../protocol/blocks.md): the worked table example.
- [Documents](../protocol/documents.md): how concurrent edits merge.
