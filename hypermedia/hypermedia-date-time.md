...
schemaDefinition: ipfs://bafyreidqf52z5iqqra3rqvx77e7ldeutxp23h7izfnqmv4v3ywbnjqzpdq
---
...
This document describes the **hypermedia-date-time** type — a schema. Its formal schema is attached (the `schemaDefinition` in this document's metadata), so the app can show it and create values of this type. <!-- id:TWO5bM7g -->
