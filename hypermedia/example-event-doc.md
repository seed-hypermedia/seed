...
schemaDefinition: ipfs://bafyreid2ot735dc4bqysgkpp4ggslt7asank2d2aarh7oojuxybydp3s3u
---
...
**Extends** [hypermedia-document](./hypermedia-document.md) with these added fields: <!-- id:APCz1dtU -->
  ...
  - `date` _(required)_ — [date](./hypermedia-date.md) <!-- id:_Ag7fzQQ -->
  - `ends` — [date](./hypermedia-date.md) <!-- id:VjLj8NPb -->
  ...
  - `outcome` — [string](./hypermedia-string.md) (one of `victory`, `defeat`, `stalemate`, `unknown`) <!-- id:29jEp_Bn -->
...
- [date](./hypermedia-date.md) <!-- id:-cgxdt72 -->
- [string](./hypermedia-string.md) <!-- id:HeRKKPgt -->
