---
name: Tool Document
summary: "every tool is a content-addressed document (DAG-CBOR, CID = version) in `~/tools/`: builtin (runtime binding), **lambda** (authored source, runs in the sandbox via `call`), or **mcp** (a projection…"
---
