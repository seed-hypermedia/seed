...
The Space index now always advertises the triggers affordance and names active triggers, so "do this every morning" is a request the agent can complete in one turn. Docs: `tools.md`, `security.md`, `persistence.md`, `agent/plans/triggers.md`, `m6-event-bus-design.md`. <!-- id:MmtbXrQ2 -->
