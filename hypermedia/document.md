...
schemaDefinition: ipfs://bafyreid3sv3p4fidfnf5jy3iz2iewk5fvp7cnrt3nte3sli7qrhlz6brq4
---
...
A **closed struct** with these fields: <!-- id:3x9xTU5x -->
  ...
  - `content` — list of [schema/block/node](./schema/block/node.md) <!-- id:7I3IBxKI -->

# Depends on <!-- id:S3YgMiYc -->

- [schema/block/node](./schema/block/node.md) <!-- id:4_ANAoOp -->
