...
Read [how Onyx works](./how-it-works.md) for the system end to end, [typed documents](../../schema/typed-documents.md) for the document-binding model, or go straight to the reference chapters from the [home page](../../schema.md). <!-- id:mdWI56L4 -->
