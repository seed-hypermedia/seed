...
- **Typed documents.** A document can say which schema it conforms to, which schema its children must conform to, or which schema it _defines_. The editor turns required fields into always-present rows and flags out-of-spec data. See [typed documents](../../schema/typed-documents.md). <!-- id:5kYrfz-H -->
...
Read [how Hypermedia Schemas work](./how-it-works.md) for the system end to end, [typed documents](../../schema/typed-documents.md) for the document-binding model, or go straight to the reference chapters from the [home page](../../schema.md). <!-- id:mdWI56L4 -->
