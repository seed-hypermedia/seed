...
---
\> Archived: this is the original proposal, preserved unchanged so the [critique](./critique.md) has a stable subject. The current design is [Everything Is a Grant](./grants.md). <!-- id:jcsxNu8e -->
