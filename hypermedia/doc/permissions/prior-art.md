...
---
Every design decision in the [permissions proposal](./v1-proposal.md) has been made before by someone, usually the hard way. This doc surveys the systems most relevant to permissions over content-addressed storage, and extracts the specific lessons that apply to Hypermedia. <!-- id:bDVf9FxX -->
...
**What they struggled with:** <!-- id:nZXR4yj3 -->
  - Revocation. UCAN ended up with a separate revocation spec that amounts to "publish a signed revocation and hope verifiers check it" — the exact tar pit described in [rabbit holes](./rabbit-holes.md). <!-- id:M6YReW1g -->
