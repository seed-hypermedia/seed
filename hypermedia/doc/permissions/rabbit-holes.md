...
---
Every one of these looks like a feature request and is actually a research area. This doc ranks the rabbit holes in the [permissions proposal](./v1-proposal.md) by how deep they go, and names the pragmatic escape from each. The theme throughout: the escape is never "solve it" — it's "choose honest semantics that don't require solving it." <!-- id:RQ_FcXWg -->
