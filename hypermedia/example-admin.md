...
schemaDefinition: ipfs://bafyreihivubb4e3ripmr7xcteqknclb2fagalu2y7xkwbj5qngxunxeztu
---
...
**Extends** [example-employee](./example-employee.md) with these added fields: <!-- id:tNotYurF -->
  - `permissions` _(required)_ — list of [string](./hypermedia-string.md) <!-- id:lrACY6mq -->

# Depends on <!-- id:rrJYZRvC -->

- [example-employee](./example-employee.md) <!-- id:NuTdLmU4 -->
- [string](./hypermedia-string.md) <!-- id:HihJcAsQ -->
