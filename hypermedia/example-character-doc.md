...
schemaDefinition: ipfs://bafyreihx7eco5kop2hnugurljzvxoshm7dxj53eqg2ekdaj5sxb65qmhdq
---
...
**Extends** [hypermedia-document](./hypermedia-document.md) with these added fields: <!-- id:dms8pLir -->
  ...
  - `born` _(required)_ — [date](./hypermedia-date.md) <!-- id:vp7r1oom -->
  - `died` — [date](./hypermedia-date.md) <!-- id:FVu4DYEh -->
  - `role` _(required)_ — [string](./hypermedia-string.md) (one of `hero`, `villain`, `ally`, `neutral`) <!-- id:T6HNkFTq -->
...
- [date](./hypermedia-date.md) <!-- id:d2oM-6Id -->
- [string](./hypermedia-string.md) <!-- id:eAML1B3O -->
