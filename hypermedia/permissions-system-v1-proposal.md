...
---
\> Archived: this is the original proposal, preserved unchanged so the [critique](./permissions-system-critique.md) has a stable subject. The current design is [Everything Is a Grant](./permissions-system-grants.md). <!-- id:jcsxNu8e -->
