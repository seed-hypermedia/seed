...
---
Before redesigning anything, here is what actually exists — from a close read of the backend. The headline: **Seed already has most of a permissions system**, spread across five mechanisms that grew separately. The [critique](./permissions-system-critique.md) and [synthesis](./permissions-system-grants.md) build directly on this map. <!-- id:jjbxMiNL -->
