...
schemaDefinition: ipfs://bafyreiatrom54mn6kplwhjdxpdcvq5hvsqdcy7s3h33jj3utheomtgrz7u
---
...
This document describes the **hypermedia-date** type — a schema. Its formal schema is attached (the `schemaDefinition` in this document's metadata), so the app can show it and create values of this type. <!-- id:qoiuf7ZN -->
