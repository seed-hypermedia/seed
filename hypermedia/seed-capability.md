...
schemaDefinition: ipfs://bafyreibhsmsmicvy6syzkvm74cdtxldsauwuey2cykwz4ur4ofexorj4re
---
...
A **closed struct** with these fields: <!-- id:9qhgoTmA -->
  - `id` _(required)_ — [string](./hypermedia-string.md) <!-- id:p0Pqs-hQ -->
  - `accountUid` _(required)_ — [string](./hypermedia-string.md) <!-- id:3FK_99NA -->
  - `role` _(required)_ — [hypermedia-role](./hypermedia-role.md) <!-- id:9j3W7BSF -->
  - `capabilityId` — [string](./hypermedia-string.md) <!-- id:jGkFhD5o -->
  - `grantId` _(required)_ — [seed-id](./seed-id.md) <!-- id:kw33mNHc -->
  - `label` — [string](./hypermedia-string.md) <!-- id:mit3zxzN -->
...
- [string](./hypermedia-string.md) <!-- id:6MwjyTWx -->
