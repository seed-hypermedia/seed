...
schemaDefinition: ipfs://bafyreihcaufixqrrg4q7yl2xgacbgem5ss7w44jifgjkhg43jsbjj4biju
---
...
A **closed struct** with these fields: <!-- id:OhtHahKP -->
  ...
  - `version` — [string](./hypermedia-string.md) <!-- id:PA6phMO_ -->
  - `account` — [string](./hypermedia-string.md) <!-- id:vwB-pjkc -->
  - `authors` _(required)_ — list of [string](./hypermedia-string.md) <!-- id:rv5pKRN_ -->
  - `path` — [string](./hypermedia-string.md) <!-- id:mwCn1Kvo -->
  - `createTime` — one of [hypermedia-timestamp](./hypermedia-timestamp.md) | [string](./hypermedia-string.md) <!-- id:gLksy_CJ -->
  - `updateTime` — one of [hypermedia-timestamp](./hypermedia-timestamp.md) | [string](./hypermedia-string.md) <!-- id:eDxwGcV- -->
  ...
  - `genesis` _(required)_ — [string](./hypermedia-string.md) <!-- id:X1W8zxVF -->
...
- [integer](./hypermedia-integer.md) <!-- id:lK3bWake -->
- [string](./hypermedia-string.md) <!-- id:qVYchjv5 -->
