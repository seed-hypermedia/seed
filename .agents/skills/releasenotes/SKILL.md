...
7. Rewrite each bullet in user-friendly language.
8. Produce the final markdown inside a code fence, using this skeleton. Omit any section that would be empty:
...
9. Replace the placeholders with real content:
   ...
   - If remote URL is known, render `Full Changelog` as
